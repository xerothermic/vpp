...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "amd64.*|x86_64.*|AMD64.*")
  ...
  check_c_compiler_flag("-march=slm" compiler_flag_march_silvermont_atom)
  if(compiler_flag_march_silvermont_atom)
    list(APPEND MARCH_VARIANTS "slm\;-march=slm -mtune=slm")
  endif()
